...
datacvcv <- datacvcv %>%
  mutate(., avg_f1_v1 = (f1_1 + f1_2 + f1_3 + f1_4) / 4,
         ...
         #avg_f1minusf0_v1 = (avg_f1 - avg_f0),
         #f1f01 = (f1_1 - f0_1),
         #f1f02 = (f1_2 - f0_2),
        # f1f03 = (f1_3 - f0_3),
         #f1f04 = (f1_4 - f0_4))
...
#restructure so portions of vowel are modelable as ind. vars on DV f0, one frame per tone
dat.f0_v1 <- melt(datacvcv,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('f0_1','f0_2','f0_3','f0_4'))
dat.lf0_v1 <- melt(Ltones_v1,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('f0_1','f0_2','f0_3','f0_4'))
dat.mf0_v1 <- melt(Mtones_v1,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('f0_1','f0_2','f0_3','f0_4'))
dat.hf0_v1 <- melt(Htones_v1,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('f0_1','f0_2','f0_3','f0_4'))
dat.f0_v2 <- melt(datacvcv,id.vars = c('block','tone2','vowel2','word', 'subj'), measure.vars = c('f0_1_v2','f0_2_v2','f0_3_v2','f0_4_v2'))
dat.lf0_v2 <- melt(Ltones_v2,id.vars = c('block','tone2','vowel2','word', 'subj'), measure.vars = c('f0_1_v2','f0_2_v2','f0_3_v2','f0_4_v2'))
dat.mf0_v2 <- melt(Mtones_v2,id.vars = c('block','tone2','vowel2','word', 'subj'), measure.vars = c('f0_1_v2','f0_2_v2','f0_3_v2','f0_4_v2'))
dat.hf0_v2 <- melt(Htones_v2,id.vars = c('block','tone2','vowel2','word', 'subj'), measure.vars = c('f0_1_v2','f0_2_v2','f0_3_v2','f0_4_v2'))

#same for HNR
dat.lh_v1 <- melt(Ltones_v1,id.vars = c('block','vowel1','tone1','word', 'subj'), measure.vars = c('hnr_1','hnr_2','hnr_3','hnr_4'))
dat.mh_v1 <- melt(Mtones_v1,id.vars = c('block','vowel1','tone1','word', 'subj'), measure.vars = c('hnr_1','hnr_2','hnr_3','hnr_4'))
dat.hh_v1 <- melt(Htones_v1,id.vars = c('block','vowel1','tone1','word', 'subj'), measure.vars = c('hnr_1','hnr_2','hnr_3','hnr_4'))
dat.lh_v2 <- melt(Ltones_v2,id.vars = c('block','vowel2','tone2','word', 'subj'), measure.vars = c('hnr_1_v2','hnr_2_v2','hnr_3_v2','hnr_4_v2'))
dat.mh_v2 <- melt(Mtones_v2,id.vars = c('block','vowel2','tone2','word', 'subj'), measure.vars = c('hnr_1_v2','hnr_2_v2','hnr_3_v2','hnr_4_v2'))
dat.hh_v2 <- melt(Htones_v2,id.vars = c('block','vowel2','tone2','word', 'subj'), measure.vars = c('hnr_1_v2','hnr_2_v2','hnr_3_v2','hnr_4_v2'))

#same for spec
dat.ls_v1 <- melt(Ltones_v1,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('specTilt_1','specTilt_2','specTilt_3','specTilt_4'))
dat.ms_v1 <- melt(Mtones_v1,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('specTilt_1','specTilt_2', 'specTilt_3','specTilt_4'))
dat.hs_v1 <- melt(Htones_v1,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('specTilt_1','specTilt_2', 'specTilt_3','specTilt_4'))
dat.ls_v2 <- melt(Ltones_v2,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('specTilt_1_v2','specTilt_2_v2','specTilt_3_v2','specTilt_4_v2'))
dat.ms_v2 <- melt(Mtones_v2,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('specTilt_1_v2','specTilt_2_v2','specTilt_3_v2','specTilt_4_v2'))
dat.hs_v2 <- melt(Htones_v2,id.vars = c('block','tone1','vowel1','word', 'subj'), measure.vars = c('specTilt_1_v2','specTilt_2_v2','specTilt_3_v2','specTilt_4_v2'))

#rearrange data to plot avg f0 over time
datf0plot_v1 <- melt(Ltones_v1,id.vars = c('subj','tone1'), measure.vars = c('f0_1','f0_2','f0_3','f0_4'))
datf0plotm_v1 <- melt(Mtones_v1,id.vars = c('subj','tone1'), measure.vars = c('f0_1','f0_2','f0_3','f0_4'))
datf0ploth_v1 <- melt(Htones_v1,id.vars = c('subj','tone1'), measure.vars = c('f0_1','f0_2','f0_3','f0_4'))
datf0plot_v2 <- melt(Ltones_v2,id.vars = c('subj','tone2'), measure.vars = c('f0_1_v2','f0_2_v2','f0_3_v2','f0_4_v2'))
datf0plotm_v2 <- melt(Mtones_v2,id.vars = c('subj','tone2'), measure.vars = c('f0_1_v2','f0_2_v2','f0_3_v2','f0_4_v2'))
datf0ploth_v2 <- melt(Htones_v2,id.vars = c('subj','tone2'), measure.vars = c('f0_1_v2','f0_2_v2','f0_3_v2','f0_4_v2'))

#don't need to normalize!
#filter for normalizing (because scale() only takes numeric, probably a better solution out there)
#datanorm <- datacvcv %>%
#  select(., avg_f1_v1, avg_spec_v1, avg_hnr_v1, avg_f0_v1, avg_jitt_v1, avg_shim_v1, avg_amp_v1,
            #avg_f1_v2, avg_spec_v2, avg_hnr_v2, avg_f0_v2, avg_jitt_v2, avg_shim_v2, avg_amp_v2)
#normalize
#datanorm <- as.data.frame(scale(datanorm))

#get columns back together
#datacvcv <- datacvcv %>%
 # select(., subj, word, onset1, vowel1, tone1, onset2, vowel2, tone2, trial, block)

  #try <- cbind(datacvcv, datanorm)


  #mutate_each(list(~scale(.) %>% as.vector), vars=c("avg_f1_v1","avg_spec_v1"))
